...
class PayloadValidatorFilterTests : public PayloadValidatorFilterTestsBase, public ::testing::Test {
public:
  PayloadValidatorFilterTests() { test_request_headers_.setPath("/"); }
...
TEST_F(PayloadValidatorFilterTests, CheckResponsePayload) {
  initialize(paths_header_config + root_path_config + post_method_config + get_method_config +
             empty_200_response_config + payload_for_200_response_config);
...
TEST_P(QueryParamsPayloadValidatorFilterTest, QueryParamsTest) {
  std::string config =
      paths_header_config + test_path_config + post_method_config + get_method_config;
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        QueryParamsTestParam({query_required_param1}, "/test?param1=just_string&param1=just_string",
                             true),
        QueryParamsTestParam({query_required_param1}, "/test?param1=just_string&param3=just_string",
                             false),
...
using PathsTestParam =
    std::tuple<std::vector<std::string>, std::string, std::vector<std::pair<std::string, bool>>>;
class PathsPayloadValidatorFilterTest : public PayloadValidatorFilterTestsBase,
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        PathsTestParam({}, "/segment1",
                       {std::make_pair<std::string, bool>("/segment1", true),
                        std::make_pair<std::string, bool>("/segment1/segment2", false),
                        std::make_pair<std::string, bool>("/segment2", false)}),
        PathsTestParam({}, "/segment1/segment2",
                       {std::make_pair<std::string, bool>("/segment1", false),
                        std::make_pair<std::string, bool>("/segment2", false),
                        std::make_pair<std::string, bool>("/segment1/segment2/segment3", false),
                        std::make_pair<std::string, bool>("/segment1/segment2", true)}),
        PathsTestParam({path_template_param1}, "/{templated_segment_1}",
                       {std::make_pair<std::string, bool>("/segment1", true),
                        std::make_pair<std::string, bool>("/100", true),
                        std::make_pair<std::string, bool>("/segment1/segment2", false),
                        std::make_pair<std::string, bool>("/segment2", true)}),
        PathsTestParam({path_template_param1}, "/segment1/{templated_segment_1}",
                       {std::make_pair<std::string, bool>("/segment1/segment2", true),
                        std::make_pair<std::string, bool>("/segment1/100", true),
                        std::make_pair<std::string, bool>("/segment1/segment2/segment3", false),
                        std::make_pair<std::string, bool>("/segment2", false)}),
        PathsTestParam({path_template_param1, path_template_param2},
                       "/segment1/{templated_segment_1}/{templated_segment_2}",
                       {std::make_pair<std::string, bool>("/segment1/segment2", false),
