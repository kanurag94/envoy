...
INSTANTIATE_TEST_SUITE_P(
    WrongConfigTestSuite, WrongConfigTest,
    testing::Values(
        ...
        std::vector<std::string>({paths_header, path_correct, operations_header, post_method,
                                  post_wrong_schema}),
        std::vector<std::string>({paths_header, path_correct, operations_header, post_method,
                                  responses_header, response_200_wrong_schema}),
        std::vector<std::string>({paths_header, path_correct, operations_header, post_method,
                                  query_param_wrong_schema}),
        std::vector<std::string>({paths_header, path_correct_templated_2, operations_header,
                                  post_method, path_param_correct}),
        std::vector<std::string>({paths_header, path_correct_templated_1, operations_header,
                                  post_method, path_param_wrong_schema}),
        std::vector<std::string>({paths_header, path_correct_templated_1_2, operations_header,
                                  post_method, path_param_correct})));
